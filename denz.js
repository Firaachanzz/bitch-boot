...
try {
		...
		const ownerNumber = [`6285866295942@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`6282280134758@s.whatsapp.net`]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© 𝐟𝐢𝐫𝐚𝐚_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/Firaachanzz"
        },
        "index": 0
      }
    ]
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Bitch Boot",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/6283830815715?text=Assalamualaikum"}}})
	}
    }
    }
    }
